...
def necessary_for_frontend(method: T | str | Field, *fields: str | Field):
    ...
    method.frontend_cover_fieldset = set(fields)  # type: ignore
    return method
...
def export_to_frontend(
    ...
    for name in dir(instance):
        ...
        if getattr(value, 'frontend_cover_fieldset', None) is not None:
            cover_fields.update(value.frontend_cover_fieldset)
